...
$.extend($.validator, {
	...
	messages: {
		...
		anorurl: "Please enter alphabets & number or valid url.",
		digits: "Please enter only number.",
		creditcard: "Please enter a valid credit card number.",
		decimal: "Please enter a valid decimal number.",
		alpha: "Please enter only alphabets.",
		alphaspace: "Please enter only alphabets.",
		fullname: "Please enter proper name.",
		alphanumeric: "Please enter alphabets & number only.",
		alphanumericspace: "Please enter only alphanumeric characters.",
		alphanumericadddess: "Sorry, these values are not allowed!",
		...
		exactlength: $.validator.format("Please enter a value exactly {0} characters.")
	},
		...
		init: function() {
			...
			$(this.currentForm)
				.validateDelegate(":text, [type='password'], [type='file'], select, textarea, " +
					...
					"focusin focusout ", delegate) /*'keyup' removed*/
	...
	classRuleSettings: {
		...
		alphanumericadddess: {alphanumericadddess: true},
	...
	methods: {
		...
		alphanumericadddess: function(value, element) {
		...
		anorurl: function(value, element) {
			return this.optional(element) || /^[a-zA-Z0-9-./:]+$/.test(value);
		},
