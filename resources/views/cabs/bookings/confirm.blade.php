          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0"
            ...
            <tr>
              <td style="
                  ...
                  text-align: center;
                  color: white;
                  background-image: url('{{ asset("images/car_bg.png") }}');
            ...
            <tr>
              <td style="padding: 32px;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                  style="width: 100%; border-bottom: 1px solid #e9ecef; padding-bottom: 16px; margin-bottom: 16px;">
                  <tr>
                    <td style="color: #6c757d; font-weight: 500; font-size: 15px;">Booking</td>
                    <td style="text-align: right;">
                      <div style="color: #495057; font-weight: 500; font-size: 15px;">
                        {{ $billingDetails->name }} × {{ $billingDetails->cab }}
                      </div>
                      <div style="color: #6c757d; font-size: 13px; margin-top: 2px;">
                        from {{ $billingDetails->pickup_location }} to {{$billingDetails->drop_location}}
                      </div>
                    </td>
                  </tr>
                </table>
