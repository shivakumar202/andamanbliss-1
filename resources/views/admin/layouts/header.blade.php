...
<header id="header" class="header">
  <div class="top-left">
    <div class="navbar-header">
      ...
      <a class="navbar-brand hidden" href="{{ url('admin/home') }}">
    ...
    <div class="header-menu">
      ...
      <div class="user-area dropdown float-right">
        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span class="px-2">{{ auth()->guard('admin')->user()->name }}</span>
          <img class="user-avatar rounded-circle" src="{{ asset('images/default.jpg') }}" alt="{{ auth()->guard('admin')->user()->name }}">
        </a>
