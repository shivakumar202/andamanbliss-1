...
@section('title', __(@$category->name . ': Meta Information'))
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/categories/' . request('categoryId') . '/meta-headings') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea name="meta_schema" id="meta_schema"
                                        class="form-control {{ $errors->has('meta_schema') ? 'is-invalid' : '' }}"
                                        rows="5"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="meta_description" id="meta_description"
                                    ...
                                    rows="3" required>{{ old('meta_description', @$meta->meta_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="og_description" id="og_description"
                                    ...
                                    rows="3">{{ old('og_description', @$meta->og_description) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select name="twitter_card" id="twitter_card"
                                    ...
                                    <option value="summary" {{ old('twitter_card', @$meta->twitter_card) == 'summary' ?
                                        'selected' : '' }}>{{ __('Summary') }}</option>
                                    <option value="summary_large_image" {{ old('twitter_card', @$meta->twitter_card) ==
                                        'summary_large_image' ? 'selected' : '' }}>{{ __('Summary Large Image') }}
                                    </option>
                                    <option value="app" {{ old('twitter_card', @$meta->twitter_card) == 'app' ?
                                        'selected' : '' }}>{{ __('App') }}</option>
                                    <option value="player" {{ old('twitter_card', @$meta->twitter_card) == 'player' ?
                                        'selected' : '' }}>{{ __('Player') }}</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="twitter_desc" id="twitter_desc"
                                    class="form-control {{ $errors->has('twitter_desc') ? 'is-invalid' : '' }}"
                                    rows="3">{{ old('twitter_desc', @$meta->twitter_desc) }}</textarea>
                            ...
                            <div class="row align-items-center justify-content-center mt-4">
                                <div class="col-md-2">
                                    <a href="{{ url('admin/categories/' . @$category->id . '/images') }}"
                                        ...
                                        <i class="fa fa-pencil-square-o"></i> {{ __('Images') }}
                                    </a>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <a href="{{ url('admin/categories/' . @$category->id . '/facilities') }}"
                                        class="btn btn-outline-info btn-block">
                                        <i class="fa fa-pencil-square-o"></i> {{ __('Facilities') }}
                                    </a>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <a href="{{ url('admin/categories/' . @$category->id . '/meta-headings') }}"
                                        ...
                                        <i class="fa fa-pencil-square-o"></i> {{ __('Meta Information') }}
                                    </a>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <a href="{{ url('admin/categories/' . @$category->id . '/reviews') }}"
                                        class="btn btn-outline-info btn-block">
                                        <i class="fa fa-pencil-square-o"></i> {{ __('Reviews') }}
                                    </a>
                                </div>
                                 <div class="align-self-center col-md-2">
