...
@section('title', __(@$category->name . ': Image'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="form" @if (@$drive)
                            action="{{ url('admin/categories/' . request('categoryId') . '/images/' . @$drive->id) }}"
                            @else action="{{ url('admin/categories/' . request('categoryId') . '/images') }}" @endif
                                ...
                                <div class="align-self-center col-md-4">
                                    <div class="form-group">
                                        <img onError="this.onerror=null;this.src='{{ asset('images/default.jpg') }}'"
                                            @if (@$drive) src="{{ @$drive->file }}" @else
                                            src="{{ asset('images/default.jpg') }}" @endif
                                            class="img img-fluid w-100 m-auto d-block" alt="" />
                                        <div class="custom-file">
                                            <input type="file" accept="image/x-png,image/jpeg" onchange="readURL(this);"
                                                name="photo"
                                                class="custom-file-input {{ $errors->has('photo') ? 'is-invalid' : '' }}"
                                                id="customFileLangHTML" />
                                            <label class="custom-file-label" for="customFileLangHTML"
                                                data-browse="{{ __('Browse') }}">{{ __('Choose file...') }}</label>
                                        </div>
                                        @if ($errors->has('photo'))
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="align-self-center col-md-2">
                                    <a href="{{ url('admin/categories/' . request('categoryId') . '/images') }}"
                        ...
                        <table id="dataTable" class="table table-striped table-hover w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img onError="this.onerror=null;this.src='{{ asset('images/default.jpg') }}'"
                                            src="{{ @$drive->file }}" class="img-fluid w-25 m-auto d-block" alt="" />
                                    </td>
                                    <td>
                                        <a href="{{ url('admin/categories/' . request('categoryId') . '/images/' . @$drive->id) }}"
