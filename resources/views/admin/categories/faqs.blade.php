...
@section('title', __(@$category->name . ': Faq'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="form" @if (@$faq)
                            action="{{ url('admin/categories/' . request('categoryId') . '/faqs/' . @$faq->id) }}" @else
                            action="{{ url('admin/categories/' . request('categoryId') . '/faqs') }}" @endif
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="align-self-center col-md-2">
                                    <a href="{{ url('admin/categories/' . request('categoryId') . '/faqs') }}"
                        ...
                        <table id="dataTable" class="table table-striped table-hover w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! $faq->answer !!}</td>
                                    <td>
                                        <a href="{{ url('admin/categories/' . request('categoryId') . '/faqs/' . @$faq->id) }}"
                                        ...
                                        <form
                                            action="{{ url('admin/categories/' . request('categoryId') . '/faqs/' . @$faq->id) }}"
