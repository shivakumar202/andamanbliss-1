    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form" action="{{ url('admin/hotels') }}" method="GET" id="form" class=""
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/hotels') }}" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ @$hotel->address }}</td>
                  <td>{{ @$hotel->featured == 1 ? 'Yes' : 'No' }}</td>
                  <td>{{ @$hotel->best_seller == 1 ? 'Yes' : 'No' }}</td>
                  <td>{{ @$hotel->ratings }} Star ({{ $hotel->reviews_count }})</td>
                  <td>{{ @$hotel->status == 'active' ? 'Active' : 'Inactive'}}</td>
                  <td>
                    <a href="{{ url('admin/hotels/' . @$hotel->id) }}" title="Details"
                      class="btn btn-xs btn-dark py-0 mx-1">
                      <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{ url('admin/hotels/' . @$hotel->id . '/edit') }}" title="Edit"
                    ...
                    <form action="{{ url('admin/hotels/' . $hotel->id) }}" method="POST" class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
                  </td>
