...
@section('title', __(@$hotel->name . ': Faq'))
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form"
            @if (@$faq)
            action="{{ url('admin/hotels/' . request('hotelId') . '/faqs/' . @$faq->id) }}"
            @else
            action="{{ url('admin/hotels/' . request('hotelId') . '/faqs') }}"
            @endif
            method="POST" id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/hotels/' . request('hotelId') . '/faqs') }}" id="reset" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{!! $faq->answer !!}</td>
                  <td>
                    <a href="{{ url('admin/hotels/' . request('hotelId') . '/faqs/' . @$faq->id) }}" title="Edit"
                    ...
                    <form action="{{ url('admin/hotels/' . request('hotelId') . '/faqs/' . @$faq->id) }}" method="POST" class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
                  </td>
