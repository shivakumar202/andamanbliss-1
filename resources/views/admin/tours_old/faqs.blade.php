...
@section('title', __(@$tour->name . ': Faq'))
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form"
            @if (@$faq)
            action="{{ url('admin/tours/' . request('tourId') . '/faqs/' . @$faq->id) }}"
            @else
            action="{{ url('admin/tours/' . request('tourId') . '/faqs') }}"
            @endif
            method="POST" id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/tours/' . request('tourId') . '/faqs') }}" id="reset" class="btn btn-block btn-outline-info my-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <form action="{{ url('admin/tours/' . request('tourId') . '/faqs/' . @$faq->id) }}" method="POST" class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
                  </td>
