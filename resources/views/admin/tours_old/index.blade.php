          ...
          <div class="card-body">
            <form name="form" action="{{ url('admin/tours') }}" method="GET" id="form" class=""
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/tours') }}" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ @$tour->id }}</td>
                  <td>{{ ucwords(@$tour->name) }}</td>
                  <td>{{ @$tour->category->name }}</td>
                  <td>{{ @$tour->address }}</td>
                  <td>{{ @$tour->featured == 1 ? 'Yes' : 'No' }}</td>
                  <td>
                    @if($tour->addon_names && !empty($tour->addon_names))
                        @foreach ($tour->addon_names as $addonName)
                            <span>{{ $addonName .'|' }}</span>
                        @endforeach
                    @else
                  ...
                  <td>{{ @$tour->ratings }} Star ({{ $tour->reviews_count }})</td>
