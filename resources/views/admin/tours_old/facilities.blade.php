...
@section('title', __(@$tour->name . ': Facility'))
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form"
            @if (@$facility)
            action="{{ url('admin/tours/' . request('tourId') . '/facilities/' . @$facility->id) }}"
            @else
            action="{{ url('admin/tours/' . request('tourId') . '/facilities') }}"
            @endif
            method="POST" id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/tours/' . request('tourId') . '/facilities') }}" id="reset" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('admin/tours/' . request('tourId') . '/facilities/' . @$facility->id) }}" title="Edit" class="btn btn-xs btn-outline-info py-0 mx-1">
                    ...
                    <form action="{{ url('admin/tours/' . request('tourId') . '/facilities/' . @$facility->id) }}" method="POST" class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
                  </td>
