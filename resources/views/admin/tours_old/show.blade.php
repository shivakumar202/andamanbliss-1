          ...
          <div class="card-body">
            <div class="row justify-content-center">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="featured" value="1" id="featured" class="custom-control-input" @checked(@$tour->featured == 1) disabled />
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <div class="custom-control custom-switch">
                    <input type="checkbox" name="best_seller" value="1" id="best_seller" class="custom-control-input" @checked(@$tour->best_seller == 1) disabled />
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <label for="title">{{ __('Heading Title')}}</label>
                  <span class="form-control">
                    {{ ucwords(@$tour->title) }}
                  </span>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="form-control">
                    {{ number_format(@$tour->adult_rate, 2) }}
                  </span>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="form-control">
                    {{ number_format(@$tour->adult_fees, 2) }}
                  </span>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="form-control">
                    {{ number_format(@$tour->child_rate, 2) }}
                  </span>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <span class="form-control">
                    {{ number_format(@$tour->child_fees, 2) }}
                  </span>
                </div>
              </div>
            ...
            <div class="row align-items-center justify-content-center">
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/images') }}" class="btn btn-block btn-outline-info my-1">
              ...
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/facilities') }}" class="btn btn-block btn-outline-info my-1">
                  <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;
              ...
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/policies') }}" class="btn btn-block btn-outline-info my-1">
                  <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;
              ...
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/faqs') }}" class="btn btn-block btn-outline-info my-1">
                  <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;
                  <span>{{ __('Faqs') }}</span>
                </a>
              </div>
              ...
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/reviews') }}" class="btn btn-block btn-outline-info my-1">
                  <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;
              ...
              <div class="align-self-center col-md-2">
                <a href="{{ url('admin/tours/' . @$tour->id . '/edit') }}" class="btn btn-block btn-info my-1">
                  <i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;
                  <span>{{ __('Edit') }}</span>
                </a>
              </div>
