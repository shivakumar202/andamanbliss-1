                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ url('admin/cabs/' . $cab->id) }}">{{ __('Details') }}</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="form"
                                @if (@$cab) action="{{ url('admin/cabs/' . request('cabId') . '/pricing/' . @$cab->id) }}"
                          @else
                          action="{{ url('admin/cabs/' . request('cabId') . '/pricing') }}" @endif
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="seat" id="seat" class="form-control" placeholder="sitting capacity" value="{{ __(@$pricing[0]->seat ) ?? '' }}">                                                
                                            @if ($errors->has('seat'))
                                    ...
                                    @foreach ($pricing as $key => $price)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ url('admin/cabs/' . request('cabId') . '/pricing/' . @$price->id) }}"
