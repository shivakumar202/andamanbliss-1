...
@section('title', __(@$activity->name . ': Image'))
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form"
            @if (@$drive)
            action="{{ url('admin/activities/' . request('activityId') . '/images/' . @$drive->id) }}"
            @else
            action="{{ url('admin/activities/' . request('activityId') . '/images') }}"
            @endif
            method="POST" id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/activities/' . request('activityId') . '/images') }}" id="reset" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('admin/activities/' . request('activityId') . '/images/' . @$drive->id) }}" title="Edit"
                    ...
                    <form action="{{ url('admin/activities/' . request('activityId') . '/images/' . @$drive->id) }}" method="POST" class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
                  </td>
