...
@section('title', __(@$activity->service_name . ': Review'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="form"
                                @if (@$review) action="{{ url('admin/activities/' . request('activityId') . '/reviews/' . @$review->id) }}"
                        @else
                        action="{{ url('admin/activities/' . request('activityId') . '/reviews') }}" @endif
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" placeholder="{{ __('Name') }}"
                                                value="{{ old('name', @$review->name) }}" id="name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" placeholder="{{ __('Address') }}"
                                                value="{{ old('address', @$review->address) }}" id="address"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="review" placeholder="{{ __('Review') }}" id="review"
                                                class="form-control {{ $errors->has('review') ? 'is-invalid' : '' }}" autocomplete="off" autofocus>{!! old('review', @$review->review) !!}</textarea>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="align-self-center col-md-2">
                                        <a href="{{ url('admin/activities/' . request('activityId') . '/reviews') }}"
                                ...
                                <tbody>
                                    @foreach ($reviews as $key => $review)
                                        <tr>
                                            ...
                                            <td>{!! @$review->review !!}</td>
                                            <td>
                                                <a href="{{ url('admin/activities/' . request('activityId') . '/reviews/' . @$review->id) }}"
                                                ...
                                                <form
                                                    action="{{ url('admin/activities/' . request('activityId') . '/reviews/' . @$review->id) }}"
