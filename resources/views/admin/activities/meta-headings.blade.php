...
@section('title', __(@$activity->service_name . ': Meta Information'))
    ...
    <div class="breadcrumbs">
        <div class="breadcrumbs-inner">
            <div class="row">
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1>{{ ucwords(@$activity->service_name) }}</h1>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ url('admin/activities') }}">{{ __('Category') }}</a></li>
                ...
                <div class="col-sm-2">
                    <a href="{{ url('admin/activities/' . request('categoryId')) }}"
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/activities/' . request('activityId') . '/meta-headings') }}"
