...
@section('title', __(@$tour->name . ': Image'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="form"
                                @if (@$drive) action="{{ url('admin/tours/' . request('tourId') . '/images/' . @$drive->id) }}" @else
              action="{{ url('admin/tours/' . request('tourId') . '/images') }}" @endif
                                    ...
                                    <div class="align-self-center col-md-4">
                                        <div class="form-group">
                                            <img onError="this.onerror=null;this.src='{{ asset('images/default.jpg') }}'"
                                                @if (@$drive) src="{{ @$drive->file }}" @else src="{{ asset('images/default.jpg') }}" @endif
                                                class="img img-fluid w-50 m-auto d-block" alt="" />
                                ...
                                <div class="row align-items-center justify-content-center">
                                    ...
                                    <div class="align-self-center col-md-2">
                                        <a href="{{ url('admin/tours/' . request('tourId') . '/images') }}" id="reset"
                                ...
                                <tbody>
                                    @foreach ($drives as $key => $drive)
                                        <tr>
                                            ...
                                            <td>
                                                <img onError="this.onerror=null;this.src='{{ asset('images/default.jpg') }}'"
                                                    src="{{ @$drive->file }}" class="img-fluid  m-auto d-block"
                                                    style="height: 50px" alt="" />
                                            </td>
                                            <td>
                                                <a href="{{ url('admin/tours/' . request('tourId') . '/images/' . @$drive->id) }}"
                                                ...
                                                <form
                                                    action="{{ url('admin/tours/' . request('tourId') . '/images/' . @$drive->id) }}"
