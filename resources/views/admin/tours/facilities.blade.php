...
@section('title', __(@$tour->name . ': Why Choose'))
        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li class="active">{{ __('Why Choose') }}</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form" @if (@$facility)
              action="{{ url('admin/tours/' . request('tourId') . '/why-us/' . @$facility->id) }}" @else
              action="{{ url('admin/tours/' . request('tourId') . '/why-us') }}" @endif method="POST" id="form"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="icon" placeholder="{{ __('<i class=" fa fa-pencil" aria-hidden="true"></i>') }}"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                      name="description" id="description" placeholder="{{ __('Description') }}" cols="30" rows="3"
                      autocomplete="off">{{ old('description', @$facility->description) }}</textarea>
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/tours/' . request('tourId') . '/facilities') }}" id="reset"
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('admin/tours/' . request('tourId') . '/why-us/' . @$facility->id) }}"
                    ...
                    <form action="{{ url('admin/tours/' . request('tourId') . '/why-us/' . @$facility->id) }}"
