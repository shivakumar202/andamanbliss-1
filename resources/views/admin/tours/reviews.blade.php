...
@section('title', __(@$tour->package_name . ': Review'))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="form" @if (@$review)
                            action="{{ url('admin/tours/' . request('tourId') . '/reviews/' . @$review->id) }}" @else
                            action="{{ url('admin/tours/' . request('tourId') . '/reviews') }}" @endif method="POST"
                            id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
                            @csrf
                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="align-self-center col-md-2">
                                    <a href="{{ url('admin/tours/' . request('tourId') . '/reviews') }}" id="reset"
                        ...
                        <table id="dataTable" class="table table-striped table-hover w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ @$review->id }}</td>
                                    <td>
                                        <img src="{{ $review->ToureviewPhotos[0]->file ?? '' }}"
                                            alt="{{ $review->name }}" style="height: 50px;">
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/tours/' . request('tourId') . '/reviews/' . @$review->id) }}"
                                        ...
                                        <form
                                            action="{{ url('admin/tours/' . request('tourId') . '/reviews/' . @$review->id) }}"
