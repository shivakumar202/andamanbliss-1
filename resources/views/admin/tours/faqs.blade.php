...
@section('title', __(@$tour->package_name . ': Faq'))
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form" @if (@$faq) action="{{ url('admin/tours/' . request('tourId') . '/faqs/' . @$faq->id) }}"
              @else action="{{ url('admin/tours/' . request('tourId') . '/faqs') }}" @endif method="POST" id="form"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="question" placeholder="{{ __('Question') }}"
                      ...
                      class="form-control {{ $errors->has('question') ? 'is-invalid' : '' }}" autocomplete="off"
                      autofocus />
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="answer" placeholder="{{ __('Answer') }}" id="answer"
                      class="form-control {{ $errors->has('answer') ? 'is-invalid' : '' }}" required autocomplete="off"
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/tours/' . request('tourId') . '/faqs') }}" id="reset"
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{!! $faq->answer !!}</td>
                  <td>
                    <a href="{{ url('admin/tours/' . request('tourId') . '/faqs/' . @$faq->id) }}" title="Edit"
                    ...
                    <form action="{{ url('admin/tours/' . request('tourId') . '/faqs/' . @$faq->id) }}" method="POST"
                      class="d-none">
                      @method('DELETE')
                      @csrf
                    </form>
