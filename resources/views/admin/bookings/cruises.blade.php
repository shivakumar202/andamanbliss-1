...
@section('title', __('Cruise Booking'))
        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li class="active">{{ __('Cruise Booking') }}</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form name="form" action="{{ url('admin/bookings/cruises') }}" method="GET" id="form" class="" enctype="multipart/form-data" novalidate="novalidate" autocomplete="off">
              ...
              <div class="row align-items-center justify-content-center">
                ...
                <div class="align-self-center col-md-2">
                  <a href="{{ url('admin/bookings/cruises') }}" class="btn btn-block btn-outline-info my-1">
            ...
            <table id="dataTable" class="table table-striped table-hover w-100">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{ @$booking->id }}</td>
                  <td>
                    #{{ str_pad(@$booking->booking_id, 20, '0', STR_PAD_LEFT) }}
                  </td>
                  <td>
                  ...
                  {{-- <td>
                    <a href="{{ url('admin/bookings/cruises/' . @$booking->id) }}" title="Details" class="btn btn-xs btn-dark py-0 mx-1">
                      <i class="fa fa-eye"></i>
                    </a>
                    <a href="{{ url('admin/bookings/cruises/' . @$booking->id . '/edit') }}" title="Edit" class="btn btn-xs btn-outline-info py-0 mx-1">
...
<script type="text/javascript">
  ...
  function changeStatus(selector) {
    ...
    $.ajax({
      method: 'POST',
      url: "{{ url('admin/bookings/cruises/changeStatus') }}",
      data: {
        id: id,
        status: status
      },
