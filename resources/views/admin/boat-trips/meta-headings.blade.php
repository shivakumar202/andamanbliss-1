...
@section('title', __(@$boatTrip->name . ': Meta Information'))
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ url('admin/boat-trips') }}">{{ __('Boat Trips') }}</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/boat-trips/' . request('tripId') . '/meta-headings') }}"
