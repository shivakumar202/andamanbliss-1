...
<head>
    <meta charset="UTF-8">
    <title>Payment Successful - Bike Rental Booking Confirmed</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p>We are happy to inform you that your payment of <span class="highlight">INR {{ number_format($billingDetails->payment->amount,2) }}</span> has been successfully received for your bike rental booking with Andaman Bliss.</p>
