@extends('layouts.app')
@section('title', 'My Bike Bookings')
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <strong>Bike : </strong> {{$booking->bikes->name }}
                                       <br>
                                     ...
                                     <td>
                                       <strong>Pickup : </strong> {{$booking->pickup}}
                                        <br>
                                        <strong>Pick & Drop Date Time : </strong> {!! $booking->pickup_date .' <strong>Drop : </strong>'. $booking->return_date . '<strong> Time : </strong>' . $booking->pickup_time !!}
                                        <br>
                                        <strong>Pickup & Drop Location : </strong> {{$booking->pickup_location}}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('bike.voucher',['bookingId' => $booking->id]) }}" target="_blank" class="btn btn-sm btn-success rounded-0">view</a>
                                        @else 
